  ...
  return (
    <div className="min-h-screen bg-[#ffb563] font-zenloop text-[#5a3a00] px-6 text-center relative overflow-x-hidden scroll-smooth">
      ...
      <section className="flex flex-col items-center justify-center min-h-[90vh] pt-20">
        ...
        {/* Section de fonctionnalités déplacée ici */}
        <section id="fonctionnalites" className="mt-12 mb-10 space-y-12">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
            <div className="bg-[#ffd29d] p-6 rounded-2xl shadow-md">
              <img src="/scan-qr.png" alt="Scan QR code" className="w-16 h-16 mx-auto mb-4" />
            ...
            <div className="bg-[#ffd29d] p-6 rounded-2xl shadow-md">
              <img src="/paiement.png" alt="Paiement" className="w-16 h-16 mx-auto mb-4" />
              <h3 className="text-2xl font-bold mb-2">Paiements suivis</h3>
              <p>Gardez une trace précise de ce que vos clients vous doivent.</p>
            </div>
            <div className="bg-[#ffd29d] p-6 rounded-2xl shadow-md">
              <img src="/preferences.png" alt="Préférences" className="w-16 h-16 mx-auto mb-4" />
        ...
        {/* Texte d’introduction placé après les cartes */}
      ...
      {/* Section témoignage utilisateur */}
      ...
      <footer className="bg-[#ffd29d] text-[#5a3a00] py-12 border-t border-[#f1b97d] mt-20 shadow-inner">
        <div className="max-w-6xl mx-auto px-6 flex flex-col items-center gap-6 text-center">
          ...
          <nav className="flex flex-wrap justify-center gap-6 text-base">
            <a href="#fonctionnalites" className="hover:text-[#891c1c] transition">Fonctionnalités</a>
            <a href="#comment" className="hover:text-[#891c1c] transition">Comment ça marche</a>
            <a href="#temoignage" className="hover:text-[#891c1c] transition">Témoignage</a>
            <a href="#cta" className="hover:text-[#891c1c] transition">Inscription</a>
